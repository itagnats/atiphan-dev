...
// OYW: Mail kept to allow easy flip-back of the "Get in Touch" button below
      ...
      <div className="mx-auto max-w-7xl px-5 pt-0 pb-14 md:px-16 md:py-16">
        ...
        >
          ...
          <div className="relative z-10 pt-2 md:pt-0">
            {/* Pill — hidden for OYW application; flip back on after */}
            {false && (
            ...
            <div className="mt-9 flex flex-wrap gap-3 md:mt-9">
              {/* View Work button — hidden for OYW application; flip back on after */}
              {false && (
                <a
                  href="#work"
            ...
            {/* Stack — hidden for OYW application; flip back on after */}
            {false && (
              <>
